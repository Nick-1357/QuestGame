...
def generate_question(question):
    chatbot = login()
    prompt = "Give me a similar question for the following question: " + question + "with answers on a new line Surround MATLAB code with '<pre>' and '</pre>'. Surround LaTeX with '$' and '$'."
    for data in chatbot.ask(prompt):
        response = data["message"]
    return response